...
def guardar():
    ...
    archivo.close()
    messagebox.showinfo('Información', 'Su reccibo ha sido guardado')
...
aplicacion.geometry('1600x630+0+0')
...
# configuracion fondo de la ventana
...
# panel izquierdo
panel_izquierdo = Frame(aplicacion, bd=1, relief=FLAT, padx=25,  pady=30)
...
lista_bebidas = ['agua', 'soda', 'jugo', 'kola', 'vino1', 'vino2', 'cerveza1', 'cerveza2']
